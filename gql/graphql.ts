...
export type SubmitFormResponseMutation = {
  __typename?: 'Mutation'
  submitFormResponse?: string | null
}
...
export type GetFormByIdQuery = {
  ...
  getFormById?: {
    ...
    autoAddTags?: Array<string | null> | null
    createdAt?: any | null
    updatedAt?: any | null
  } | null
}
...
export type GetPublicFormDataQuery = {
  __typename?: 'Query'
  getPublicFormData?: {
    __typename?: 'FormPublicData'
    primaryColor: string
...
export type GetFormResponsesByFormIdQuery = {
  __typename?: 'Query'
  getFormResponsesByFormId?: Array<{
    __typename?: 'FormResponse'
    id: string
    formId: string
    name: string
...
export type GetFormResponsesByProjectIdQuery = {
  __typename?: 'Query'
  getFormResponsesByProjectId?: Array<{
    __typename?: 'FormResponse'
    id: string
    formId: string
    name: string
...
export type GetProjectByDomainQuery = {
  __typename?: 'Query'
  getProjectByDomain?: {
    __typename?: 'Project'
    id: string
...
export type SigninWithEmailPasswordQuery = {
  __typename?: 'Query'
  singinwithEmailPassword?: string | null
}
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'CreateFormData' },
            },
          },
        },
      ],
...
export const SubmitFormResponseDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'SubmitFormResponse' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'SubmitFormResponseData' },
            },
          },
        },
      ],
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'CreateProjectData' },
            },
          },
        },
      ],
...
export const CreateUserWithEmailAndPasswordDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateUserWithEmailAndPassword' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'data' } },
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'CreateUserData' },
            },
          },
        },
      ],
  ...
  CreateUserWithEmailAndPasswordMutationVariables
>
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'GetFormsInput' },
            },
          },
        },
      ],
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetFormById' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'getFormByIdId' },
          },
          type: {
            kind: 'NonNullType',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'introMessage' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'promptTitle' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'promptDescription' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'thankyouTitle' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'thankyouMessage' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'enableCTA' } },
                { kind: 'Field', name: { kind: 'Name', value: 'ctaTitle' } },
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'collectVideoTestimonials' },
                },
                {
                  kind: 'Field',
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'collectRatings' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'collectImages' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'collectEmail' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'collectJobTitle' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'collectUserImage' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'collectWebsiteURL' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'collectCompany' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'autoApproveTestimonials' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'autoAddTags' } },
                { kind: 'Field', name: { kind: 'Name', value: 'createdAt' } },
                { kind: 'Field', name: { kind: 'Name', value: 'updatedAt' } },
              ],
            },
...
} as unknown as DocumentNode<GetFormByIdQuery, GetFormByIdQueryVariables>
export const GetPublicFormDataDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'GetPublicFormDataInput' },
            },
          },
        },
      ],
  ...
  GetPublicFormDataQuery,
  GetPublicFormDataQueryVariables
>
export const GetFormResponsesByFormIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'GetFormResponsesByFormIdInput' },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'testimonial' } },
  ...
  GetFormResponsesByFormIdQueryVariables
>
export const GetFormResponsesByProjectIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetFormResponsesByProjectId' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'GetFormResponsesByProjectIdInput' },
            },
          },
        },
      ],
  ...
  GetFormResponsesByProjectIdQueryVariables
>
...
export const GetProjectByDomainDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetProjectByDomain' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  GetProjectByDomainQuery,
  GetProjectByDomainQueryVariables
>
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetSessionUser' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'authenticationType' },
                },
                {
                  kind: 'Field',
...
} as unknown as DocumentNode<GetSessionUserQuery, GetSessionUserQueryVariables>
export const SigninWithEmailPasswordDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SigninWithEmailPassword' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'singinwithEmailPassword' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'email' },
  ...
  SigninWithEmailPasswordQuery,
  SigninWithEmailPasswordQueryVariables
>
