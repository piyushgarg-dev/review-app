  ...
  const getFormPublicLink = useCallback(
    ({
      ...
      if (customDomain) _state.domain = customDomain
        ...
        _state.domain = `${subdomain}.${process.env.NEXT_PUBLIC_APP_CUSTOM_DOMAIN}`
          ...
          >
            <div className="group flex items-center gap-4 px-4 py-2.5">
              ...
              <div className="flex items-center text-gray-500">
                <button
                  className="offset_ring hover:dark-bg-gray-700 mx-1 hidden rounded-full border border-gray-100 bg-gray-50 px-2 py-1 text-gray-500 hover:bg-gray-100 dark:border-gray-900 dark:bg-gray-800 hover:dark:bg-gray-800/[.3] xl:block"
                ...
                {actionButtons.map(({ label, icon: Icon, color }, i) => (
                  <TooltipProvider delayDuration={1} key={i}>
                    <Tooltip>
                      <TooltipTrigger
                        onClick={() =>
